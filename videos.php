...
<nav class="navbar fixed-top shadow-sm  navbar-light bg-light" style="height: 65px;" >
  ...
  <h4 style="margin-left: 50px;">Match Videos and Feeds</h4>
  <form class="form-inline mx-auto my-2 my-lg-0">
      <input class="form-control mr-sm-2" type="search" placeholder="search by videos" aria-label="Search">
...
<div class="sidenav shadow-sm navbar-light bg-light">
  ...
  <a href="videos.php" class="active"   >Match Videos</a>
  <a href="roulette.php" style="color: #005A5B;" >Roullete</a>
  <a href="weeks.php" style="color: #005A5B;"  >Management</a>
</div>
<div class="main">
